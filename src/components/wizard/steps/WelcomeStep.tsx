  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[500px] text-center px-4">
      ...
      <div className="relative z-10 max-w-lg">
        ...
        {/* What you'll need */}
        <div className="bg-derby-card/50 border border-gray-800 rounded-2xl p-6 mb-10 text-left">
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={item} className="flex items-center gap-3 text-gray-300">
                <span className="w-6 h-6 rounded-full bg-derby-blue/20 flex items-center justify-center flex-shrink-0">
                  <svg
