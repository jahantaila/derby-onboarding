        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 text-left shadow-sm">
          ...
          <div className="space-y-3">
            {[
              ...
              { icon: "M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z", text: "Google Business Profile optimization" },
