    ...
    <div className="hidden lg:flex lg:flex-col lg:w-[320px] lg:min-w-[320px] bg-white border-r border-gray-200 p-6">
      ...
      <div className="flex-1">
                ...
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 transition-all duration-300 ${
                    isCompleted
                      ...
                      : isActive
                      ? "bg-gradient-to-r from-derby-blue to-derby-blue-deep text-white ring-2 ring-derby-blue/30 ring-offset-2 ring-offset-white"
        ...
        <div className="mt-6 pt-4 border-t border-gray-100">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs font-semibold text-derby-blue">{completionPercent}%</span>
          </div>
      ...
      <div className="mt-auto pt-6 space-y-3">
        ...
        {isWizardStep && nextStep && currentStep < 6 && (
          <button
            onClick={goNext}
            className="w-full px-4 py-3 rounded-xl bg-gradient-to-r from-derby-blue to-derby-blue-deep text-white font-semibold text-sm hover:shadow-lg hover:shadow-derby-blue/25 transition-all flex items-center justify-center gap-2"
          >
            Next: {nextStep.title}
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8">
        <div className="w-20 h-20 rounded-2xl bg-gray-200 animate-pulse mb-8" />
